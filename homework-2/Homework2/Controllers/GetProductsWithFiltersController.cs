...
{
    [ApiController]
    [Route("/Homework2/GetProductsByFilters/[controller]")]
    public class GetProductsWithFiltersController : ControllerBase
    {
        ...
        public ActionResult<GetProductsWithFiltersResponse> GetProductsByFilters(GetProductsWithFiltersRequest getProductsWithFiltersRequest)
        {
            try
            {
